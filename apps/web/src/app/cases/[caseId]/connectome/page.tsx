      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '1.5rem' }}>
        ...
        <div className="card">
          ...
          <div style={{ background: '#090d16', padding: '0.75rem', borderRadius: '0.375rem', fontSize: '0.8125rem', display: 'flex', flexDirection: 'column', gap: '0.375rem' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'var(--text-secondary)' }}>Correlation Strength (r):</span>
              <strong style={{ color: '#34d399' }}>r = -0.42 (Significant)</strong>
            </div>
          </div>
        </div>
        ...
        <div className="card">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.75rem' }}>
            ...
            <span className={`badge ${isLowReliability ? 'badge-tier3' : 'badge-tier1'}`}>
              {isLowReliability ? 'Low Reliability' : 'High Consistency'}
            </span>
          </div>
          <p style={{ fontSize: '0.8125rem', color: '#cbd5e1', marginBottom: '0.75rem' }}>
          ...
          <div style={{ background: '#090d16', padding: '0.75rem', borderRadius: '0.375rem', fontSize: '0.8125rem', display: 'flex', flexDirection: 'column', gap: '0.375rem' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              ...
              <strong style={{ color: isLowReliability ? '#fbbf24' : '#34d399' }}>
                {isLowReliability ? 'Exceeds coil focal zone' : 'Within ~20mm FWHM E-field'}
              </strong>
            </div>
          </div>
        </div>
