      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
        <div>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem' }}>
            Tracking MADRS, GAD-7, and clinical global impression trajectories across TMS treatment sessions.
          </p>
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '1.5rem' }}>
        ...
        <div className="card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', fontSize: '0.875rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0.5rem', background: 'var(--bg-surface-elevated)', borderRadius: '0.375rem' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0.5rem', background: 'var(--bg-surface-elevated)', borderRadius: '0.375rem' }}>
              ...
              <strong style={{ color: '#34d399' }}>11 (Mild / Near Remission — 68% reduction)</strong>
            </div>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', fontSize: '0.875rem' }}>
            ...
            <div>
              <span style={{ color: 'var(--text-secondary)' }}>Target Engagement Verification:</span>
              <p style={{ fontSize: '0.8125rem', color: '#cbd5e1', marginTop: '0.25rem' }}>
                Concordant with predicted therapeutic circuit engagement on sgACC anti-correlation network.
              </p>
            </div>
          </div>
        </div>
