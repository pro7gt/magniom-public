    ...
    <div className="container" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      >
        <div>
          ...
          >
            Multi-tenancy configuration, scientific policy manifests, worker node health, and audit
            logging.
          </p>
        </div>
        ...
        <div className="card" style={{ padding: '1.5rem' }}>
          ...
          <table className="comparison-table" style={{ marginTop: '1rem' }}>
            ...
            <tbody>
              <tr>
                <td>
                  <code style={{ color: 'var(--accent-cyan)' }}>org-melb-tms</code>
                </td>
                <td>Melbourne TMS Centre</td>
                <td>Parkville Clinical Neurosciences (Site 1)</td>
                <td>
                  <span className="badge badge-clinical">CLINICAL</span>
                </td>
                <td>MDD, PAIN, STROKE_MOTOR</td>
                <td>
                  <span className="badge badge-tier1">ACTIVE</span>
                </td>
              </tr>
              <tr>
                <td>
                  <code style={{ color: 'var(--accent-cyan)' }}>org-syd-research</code>
                </td>
              ...
              <tr>
                <td>
                  <code style={{ color: 'var(--accent-cyan)' }}>org-bris-val</code>
                </td>
                <td>Queensland Brain Health Centre</td>
                <td>Herston Clinical Research Unit</td>
                <td>
                  <span className="badge badge-validation">VALIDATION</span>
                </td>
