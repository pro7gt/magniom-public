...
export class AudiologyProvider implements MeasurementProvider<AudiologyMeasurement> {
  ...
  public readonly manifest: MeasurementProviderManifest = {
    ...
    capabilities: [
      ...
      {
        capabilityCode: 'tinnitus_frequency_context',
        description: 'Matched tinnitus pitch frequency context (§67).',
        supportedModalities: ['audiology'],
        defaultStatus: 'qualified',
        requiresIndicationQualification: true,
      },
      {
        capabilityCode: 'auditory_target_research_context',
        description: 'Research context for auditory cortical targeting (§67).',
        supportedModalities: ['audiology'],
        defaultStatus: 'qualified',
        requiresIndicationQualification: true,
      },
      {
        capabilityCode: 'tinnitus_module_eligibility',
        description: 'Eligibility validation for tinnitus neuromodulation protocols (§67).',
        supportedModalities: ['audiology'],
        defaultStatus: 'qualified',
        requiresIndicationQualification: true,
      },
      {
        capabilityCode: 'tinnitus_phenotype_context',
        description: 'Comprehensive audiological and tinnitus phenotype profiling (§67, §169).',
        supportedModalities: ['audiology'],
        defaultStatus: 'qualified',
        requiresIndicationQualification: true,
      },
